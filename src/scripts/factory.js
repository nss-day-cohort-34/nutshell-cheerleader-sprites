...
const factory = Object.create({
  ...
  <section class="newsHTML">
      <h2 class="newsHTMLHeader">${object.title}</h2>
      <p>${object.summary}</p>
 ...
 <div class="addEvent__form--div" >   
    <section class="addEvent__form">
        ...
        <input type="hidden" id="eventId" value="${event ? event.id : ""}" />
                    Event Name: <input id="eventName" value="${
                      event ? event.name : ""
                    }" type="text" name="eventName" class="event__form--input"><br>
                    Event Date: <input id="eventDate" value="${
                      event ? event.date : ""
                    }" type="date" name="eventDate" class="event__form--input"><br>
                    Event Location: <input id="eventLocation" value="${
                      event ? event.location : ""
                    }" type="text" name="eventLocation" class="event__form--input"><br>
